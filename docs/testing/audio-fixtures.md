...
has a leading empty edit, while packet coverage begins at sample 5,952 and ends
at sample 29,901 for the regression request. The manifest records both clocks
and the expected analyzer onset at sample 18,912. This fixture catches
implementations that concatenate decoded buffers while discarding presentation
timestamps or confuse the track interval with decoded packet coverage.
